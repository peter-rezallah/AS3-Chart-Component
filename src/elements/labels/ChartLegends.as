...
package elements.labels {
	...
	public class ChartLegends extends BaseLabel {
		public var colour:Number;
		public var size:Number;
		private var top_padding:Number = 0;
		
		public function ChartLegends( json:Object )
		{
			super();
			if( !json )return;
		...
		public function resize(rWidth:Number):void {
			/*if( this.text == null )
				return ;*/
			
			
			this.width = rWidth ;
			closeButton.x = rWidth - closeButton.width ;
