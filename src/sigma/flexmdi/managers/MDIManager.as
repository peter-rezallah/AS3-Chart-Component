package sigma.flexmdi.managers
{
	...
	import sigma.flexmdi.effects.MDIEffectsDescriptorBase;
	import sigma.flexmdi.effects.effectClasses.MDIGroupEffectItem;
	 ...
	 */
	[Event(name="windowAdd", type="sigma.flexmdi.events.MDIManagerEvent")]
	 ...
	 */
	[Event(name="windowMinimize", type="sigma.flexmdi.events.MDIManagerEvent")]
	 ...
	 */
	[Event(name="windowRestore", type="sigma.flexmdi.events.MDIManagerEvent")]
	 ...
	 */
	[Event(name="windowMaximize", type="sigma.flexmdi.events.MDIManagerEvent")]
	 ...
	 */
	[Event(name="windowClose", type="sigma.flexmdi.events.MDIManagerEvent")]
	 ...
	 */
	[Event(name="windowFocusStart", type="sigma.flexmdi.events.MDIManagerEvent")]
	 ...
	 */
	[Event(name="windowFocusEnd", type="sigma.flexmdi.events.MDIManagerEvent")]
	 ...
	 */
	[Event(name="windowDragStart", type="sigma.flexmdi.events.MDIManagerEvent")]
	 ...
	 */
	[Event(name="windowDrag", type="sigma.flexmdi.events.MDIManagerEvent")]
	 ...
	 */
	[Event(name="windowDragEnd", type="sigma.flexmdi.events.MDIManagerEvent")]
	 ...
	 */
	[Event(name="windowResizeStart", type="sigma.flexmdi.events.MDIManagerEvent")]
	 ...
	 */
	[Event(name="windowResize", type="sigma.flexmdi.events.MDIManagerEvent")]
	 ...
	 */
	[Event(name="windowResizeEnd", type="sigma.flexmdi.events.MDIManagerEvent")]
	 ...
	 */
	[Event(name="cascade", type="sigma.flexmdi.events.MDIManagerEvent")]
	 ...
	 */
	[Event(name="tile", type="sigma.flexmdi.events.MDIManagerEvent")]
	...
	public class MDIManager extends EventDispatcher
	{
		...
		public var tileMinimizeWidth:int = 520;
		...
		public var disableTopLeft:Boolean = false ;
     	...
     	*   Contstructor()
     	*/
		public function MDIManager(container:UIComponent, effects:IMDIEffectsDescriptor = null , contextMenu:Boolean=true ):void
		{
		...
		/**
		 * show hide the defualt context Menu 
		 * */
		[inspectable(enumeration="true,flase")]
		...
		public function addContextMenu(window:MDIWindow,contextMenu:ContextMenu=null):void
		{
			...
			if(_useContextMenu)
			{
				if(contextMenu == null)
				{
					...
					var arrangeItem:ContextMenuItem = new ContextMenuItem(Constants.CONTEXT_MENU_LABEL_TILE);
					...
					var arrangeFillItem:ContextMenuItem = new ContextMenuItem(Constants.CONTEXT_MENU_LABEL_TILE_FILL);
					...
					var cascadeItem:ContextMenuItem = new ContextMenuItem(Constants.CONTEXT_MENU_LABEL_CASCADE);
					...
					var showAllItem:ContextMenuItem = new ContextMenuItem(Constants.CONTEXT_MENU_LABEL_SHOW_ALL);
