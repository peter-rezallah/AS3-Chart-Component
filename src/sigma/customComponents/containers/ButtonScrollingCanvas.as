package sigma.customComponents.containers
{
	...
	public class ButtonScrollingCanvas extends Canvas
	{
		...
		private var _upDownButtonWidth:Number;
		...
		public function set upDownButtonWidth(val:Number):void
		{
			_upDownButtonWidth = val ;
		}
		...
		private function positionButtons(unscaledWidth:Number, unscaledHeight:Number):void {
			...
			upButton.move((unscaledWidth / 2 )- ( _upDownButtonWidth / 2 ) , 0);
			downButton.move((unscaledWidth / 2 )- (_upDownButtonWidth / 2) , unscaledHeight - buttonWidth);
			
			
			if(_upDownButtonWidth >= 0)
			{
				upButton.setActualSize(_upDownButtonWidth , buttonWidth);
				downButton.setActualSize(_upDownButtonWidth , buttonWidth);
			}else{
