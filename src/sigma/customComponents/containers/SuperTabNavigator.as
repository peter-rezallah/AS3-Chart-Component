package sigma.customComponents.containers
{
  ...
  import sigma.customComponents.controls.ScrollableArrowMenu;
  import sigma.customComponents.controls.SuperTabBar;
  import sigma.customComponents.controls.tabBarClasses.SuperTab;
  import sigma.customComponents.events.SuperTabEvent;
  import sigma.customComponents.events.TabReorderEvent;
  import sigma.customComponents.skins.TabPopUpButtonSkin;
   ...
   */
  [Event(name="tabClose", type="sigma.customComponents.events.SuperTabEvent")]

  [Event(name="tabsReordered", type="sigma.customComponents.events.TabReorderEvent")]
