package {
	...
	public class NumberFormat
	{
		...
		public static var DEFAULT_NUM_DECIMALS_4:Number = 4;
		
		public var numDecimals:Number = DEFAULT_NUM_DECIMALS;
		public var numDecimals4:Number = DEFAULT_NUM_DECIMALS_4;
		...
		public function NumberFormat( numDecimals:Number, isFixedNumDecimalsForced:Boolean, isDecimalSeparatorComma:Boolean, isThousandSeparatorDisabled:Boolean )
		{
			...
			this.numDecimals4 = Parser.getNumberValue (numDecimals4, DEFAULT_NUM_DECIMALS_4, true, false);
...
//				}
	...
	//			 trace (_instance.isThousandSeparatorDisabled);
		...
		public static function getInstance4( json:Object ):NumberFormat {
			if (_instance == null) {
				//				if (lv==undefined ||  lv == null){
				//					lv=_root.lv;
				//				}
