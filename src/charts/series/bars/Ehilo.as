package charts.series.bars
{
	...
	public class Ehilo extends Base
	{
		protected var high:Number;
		protected var low:Number;
		protected var negative_colour:Number;
		
		public function Ehilo(index:Number, props:Properties, group:Number)
		{
		...
		public override function resize( sc:ScreenCoordsBase ):void {
			...
			this.draw_line(c, bar_top, h.height, mid);
		...
		private function draw_line(colour:Number, top:Number, bottom:Number, width:Number):void {
