package charts
{
	...
	public class CompareLines extends Base
	{
		// JSON style:
		...
		public function CompareLines(json:Object)
		{
		...
		protected override function get_element( index:Number, value:Object ): Element {
			...
			if ( value is Object )
				value = { value:value.percentage,tip:NumberUtils.formatNumberY3(value.value)+"<br>#x_label#" };
			...
			tmp.set( 'tip', tmp.get('timeStamp').replace('#x_label#', this.x_label) );*/
