package charts {
	...
	public class ObjectCollection
	{
		...
		public function closest( x:Number, y:Number ):Element {
			var o:Object;
			var s:Base;
		...
		*/
		...
		public function closest_2( x:Number, y:Number ):Array {
			...
			//trace("good_x_and_y = " + e.x + " , " + e.y);
			return good_x_and_y;
		}
		
		public function closest_2_toSpecificDataSet( x:Number, y:Number , chartIndex:int ):Array {
			...
			var closest:Array = sets[chartIndex].closest_2( x, y );
