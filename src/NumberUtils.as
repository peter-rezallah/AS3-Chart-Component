package {
	public class NumberUtils {
		...
		public static function formatNumberYLabels4 (i:Number) : String{
			var format:NumberFormat = NumberFormat.getInstance4(null);
			return NumberUtils.format (i, 
				format.numDecimals4, 
				format.isFixedNumDecimalsForced, 
				format.isDecimalSeparatorComma,
		...
		public static function formatNumberY3 (i:Number) : String{
			var format:NumberFormat = NumberFormat.getInstanceY2(null);
			return NumberUtils.format (i, 
				3, 
				format.isFixedNumDecimalsForced, 
